...
import { Crown, Radio, FileText } from 'lucide-react';

export function WelcomeMessage() {
  return (
    <div className="max-w-4xl mx-auto text-center py-12 px-6">
      {/* Vintage emblem logo instead of portrait */}
      <div className="flex items-center justify-center mb-8">
        <div className="bg-wartime-700 text-wartime-100 rounded-full w-24 h-24 flex items-center justify-center shadow-vintage border-4 border-victory-600 text-4xl font-bold font-serif tracking-wider">
          CTM
        </div>
      </div>
